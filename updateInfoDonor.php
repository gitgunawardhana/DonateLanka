  ...
  if ($_SESSION["usertype"] == "user"){
    ...
    if($query == 1){
      if($usertype == "donor"){
        ...
        window.location.href = "./Donor/donorHome.php";</script>';
      }else {
        echo '<script type="text/javascript">
        alert("Update Successful !");
	...
	if(isset($_POST['back'])){
		if($usertype == "donor"){
			echo '<script type="text/javascript">window.location.href = "./Donor/donorHome.php";</script>';
		}else {
    ...
    <form action="#" method="POST">
      ...
      <div class="mb-3" style="display: flex;">
        ...
        <div style="width: 100%;">
          ...
          <input type="text" class="form-control" id="inputBloodGroup" value="<?php echo $blood_group; ?>" name="blood_group" <?php if($_SESSION["usertype"] == "admin"){ ?> disabled <?php } ?>>
        </div>
      </div>
      <div class="mb-3" style="display: flex;">
        <div style="width: 100%;">
