<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $dst = "./Upload/Avatar/Authorizer/".$next_img_id.$profilePicture;
    $dst_db = "Upload/Avatar/Authorizer/".$next_img_id.$profilePicture;
    ...
    if($password != $Cpassword){
      ...
      if ($_SESSION["usertype"] == "admin"){
        $insert1 = "INSERT INTO `authorizer` (nic, first_name, last_name, gender, age, profile_picture, email, telephone_mobile, telephone_home, occupation, address_residential, address_official, username,password, status) VALUES ('$nic','$first_name','$last_name','$gender','$age','$dst_db','$email','$telephone_mobile', '$telephone_home', '$occupation','$address_residential','$address_official','$username','$password', 'Approved')";
      }else{
        $insert1 = "INSERT INTO `authorizer` (nic, first_name, last_name, gender, age, profile_picture, email, telephone_mobile, telephone_home, occupation, address_residential, address_official, username,password, status) VALUES ('$nic','$first_name','$last_name','$gender','$age','$dst_db','$email','$telephone_mobile', '$telephone_home', '$occupation','$address_residential','$address_official','$username','$password', 'Pending')";
      }
      $query = mysqli_query($con, $insert1) or die(mysqli_error($con));
      if($query == 1){	
        setcookie('message', "Registration Successful !", time()+3);
        header("location:./registrationAuthorizer.php");		
...
<body>
        ...
        <ul class="navbar-nav ml-auto mb-2 mb-lg-0" <?php if($_SESSION['usertype'] != "user"){ ?> style="margin-right: 20px;" <?php } ?>>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              <?php if($_SESSION["usertype"] == "admin") {?> Add User <?php }elseif($_SESSION["usertype"] == "authorizer") {?> Register <?php }else {?> Register <?php } ?>
            </a>
  ...
  <div class="container custom-container">
    ...
    ?>
    <h2 style="padding-bottom: 20px;"><b>Authorizer Registration</b></h2>
    <form action="#" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3" style="display: flex;">
        <div style="width: 100%;">
          ...
          <input type="phone" class="form-control" id="inputMobile" aria-describedby="mobileHelp" name="telephone_mobile" maxlength="10" required>
        ...
        <div style="width: 50px;"></div>
        <div style="width: 100%;">
          <label for="inputTelephone" class="form-label">Telephone (Home)</label>
          <input type="phone" class="form-control" id="inputTelephone" aria-describedby="mobileHelp" name="telephone_home" maxlength="10" required>
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="inputAddress" name="address_residential" required>
      </div>
      <div class="mb-3">
        <label for="inputAddress" class="form-label">Official Address</label>
        <input type="text" class="form-control" id="inputAddress" name="address_official" required>
      </div>
      <div class="mb-3" style="display: flex;">
        <div style="width: 100%;">
